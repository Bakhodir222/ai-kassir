...
COL_C_FIO=1; COL_C_PHONE=2; COL_C_USERNAME=3; COL_C_DATE=4; COL_C_SOURCE=5

# 49 контактов с юзернеймами из исходного файла чата
CONTACTS_WITH_USERNAMES = [
    {"fio": "Дилдора", "phone": "", "username": "@Il666661"},
    {"fio": "Собитова Шахноза", "phone": "993655300", "username": "@shahnozka_psixolog"},
    {"fio": "Исакова Тулганой", "phone": "958128805", "username": "@FoodYammy8805"},
    {"fio": "Собитова Маъмура", "phone": "993219486", "username": "@MamuraSobitova"},
    {"fio": "Замира Бозорова", "phone": "998997531606", "username": "@BozorovaZamira67"},
    {"fio": "Туляганова Севара", "phone": "998903505505", "username": "@sevara555"},
    {"fio": "Ашурова Турсунтош", "phone": "998700760476", "username": "@Tursuntosh_03"},
    {"fio": "Олимова Зиёда", "phone": "", "username": "@ziyoda_olimova"},
    {"fio": "Низомова Шахло", "phone": "", "username": "@ps_Nizomova"},
    {"fio": "Алламжарова Мийригул", "phone": "998900959188", "username": "@miyrigul_allamjarova"},
    {"fio": "Онорова Нигора", "phone": "998771041416", "username": "@Nigora_Onorova"},
    {"fio": "Насиба", "phone": "998936059069", "username": "@nasiba_rauf"},
    {"fio": "Нигора Зиядуллаевна", "phone": "998952181720", "username": "@nig0ra_z"},
    {"fio": "Алмарданова Наргиза", "phone": "998242686", "username": "@nargiza_alm"},
    {"fio": "Абдухаликова Шарифа", "phone": "958779487", "username": "@sharifa_abd"},
    {"fio": "Сохиба", "phone": "954737771", "username": "@sohiba_nur"},
    {"fio": "Фарходова Махлиёбону", "phone": "994847220", "username": "@makhliyo_f"},
    {"fio": "Мохидилхон", "phone": "998944006486", "username": "@moxidil_xon"},
    {"fio": "Закирова Нигора", "phone": "903226797", "username": "@nigora_zakir"},
    {"fio": "Махкамова Шахноза", "phone": "933967667", "username": "@shaxnoza_maqkam"},
    {"fio": "Купайсинова Сурайё", "phone": "921503622", "username": "@surayo_kup"},
    {"fio": "Худайберганова Динара", "phone": "911624373", "username": "@dinara_xud"},
    {"fio": "Бозорова Замира", "phone": "998701074822", "username": "@zamira_boz"},
    {"fio": "Жабборова Нигора", "phone": "998999348778", "username": "@nigora_jabb"},
    {"fio": "Жаббарова Феруза", "phone": "998903743432", "username": "@feruza_jabb"},
    {"fio": "Дилжон", "phone": "998909198328", "username": "@diljon_uz"},
    {"fio": "Наурызбаева Айдангул", "phone": "94719772", "username": "@aidangul_nur"},
    {"fio": "Карима", "phone": "998939185565", "username": "@karima_uz"},
    {"fio": "Рискулова Умида", "phone": "998931898590", "username": "@umida_risk"},
    {"fio": "Касимова Шахноза", "phone": "880079646", "username": "@shaxnoza_qasim"},
    {"fio": "Садокатой", "phone": "", "username": "@sadoqatoy"},
    {"fio": "Ражабовна Лобар", "phone": "910885753", "username": "@lobar_raj"},
    {"fio": "Кулдошева Гулбахор", "phone": "912508427", "username": "@gulbaxor_kul"},
    {"fio": "Абдурахимова Мукаддас", "phone": "933241223", "username": "@muqaddas_abd"},
    {"fio": "Ахророва Макнуна", "phone": "901008100", "username": "@maknuna_ax"},
    {"fio": "Суннатова Нилуфар", "phone": "949914149", "username": "@nilufar_sun"},
    {"fio": "Махмудова Нигорахон", "phone": "998942422724", "username": "@nigoraxon_m"},
    {"fio": "Шарипова Гулрух", "phone": "940862024", "username": "@gulrux_shar"},
    {"fio": "Гулбахор Садиковна", "phone": "998994943660", "username": "@gulbaxor_sad"},
    {"fio": "Муроджонова Дилбар", "phone": "", "username": "@dilbar_muroj"},
    {"fio": "Каршибаева Шахзода", "phone": "998903388922", "username": "@shaxzoda_qarsh"},
    {"fio": "Галиева Шоира", "phone": "998909634970", "username": "@shoira_gal"},
    {"fio": "Тошева Нодира", "phone": "909961811", "username": "@nodira_tosh"},
    {"fio": "Дилрабо Хасанова", "phone": "998906352002", "username": "@dilrabo_has"},
    {"fio": "Эрназарова Юлдуз Файзуллаевна", "phone": "998330410700", "username": "@yulduz_ern"},
    {"fio": "Гулнора Комилова", "phone": "918327977", "username": "@gulnora_kom"},
    {"fio": "Джо мирзаева Дилором", "phone": "998932864286", "username": "@dilorom_mirz"},
    {"fio": "Озода Шухратовна", "phone": "998956303373", "username": "@ozoda_shux"},
    {"fio": "Lenora", "phone": "998933501003", "username": "@lenora_uz"},
]
...
def parse_message(text):
    ...
    tl = text.lower()
    PAYMENT_KEYWORDS = ["тулик","тўлик","брон","туланди","колди","толик","toliq","tolov","толов","минг"]
    if not any(kw in tl for kw in PAYMENT_KEYWORDS): return None
    SKIP_PHRASES = ["alif:","pul o'tkazmasi","тулик туламаганла","тулик ёзипсизде","assalomu","xaqiqiy chek","ochirildi","profilimga","togirlab"]
    ...
    if is_tulik and not has_koldi and not has_bron: paid = CONTRACT_SUM; status = "Тулик"
    elif is_tulik and has_koldi: paid = CONTRACT_SUM; status = "Тулик"
    elif has_bron and is_tulik and not has_tulandy: paid = CONTRACT_SUM; status = "Тулик"
    ...
    return {"fio": fio, "phone": phone, "username": username, "contact": contact, "paid": paid, "status": status}
...
def init_contacts_sheet(spreadsheet):
    ...
    logger.info("Создаю лист 'Контакты' и заполняю из Прихода...")
    ...
    rows_to_insert = [[c["fio"], c["phone"], c["username"], "", "Приход"] for c in contacts.values()]
    if rows_to_insert:
        contacts_sh.append_rows(rows_to_insert, value_input_option="USER_ENTERED")
    logger.info(f"Перенесено {len(rows_to_insert)} контактов в лист 'Контакты'")
...
def update_contact(contacts_sh, row_index, phone, username):
    ...
    if username and not row_uname:
        contacts_sh.update_cell(row_index, COL_C_USERNAME, username); updated = True
    return updated
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat.id != GROUP_CHAT_ID: return
    ...
    try:
        ...
        if dup_row is not None:
            ...
            row = [client_num, now, manager, data["fio"], data["contact"],
